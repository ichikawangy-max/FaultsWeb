const CONFIG = {
    mainQuestion: "Mau Ga Kamu Maafin Agaa??",
    subQuestion: "Pliss Maauuui ",
    yesButton: "MAUU",
    noButton: "GAMAUU",
    noEscapeTexts: ["Eits, gabolehh😝", "Hehe, haruss mauu tauukk 😜", "Ishh, agaa anggap Mauu ya! 💕"],
    confirmTitle: "YEAAAY! Sayaangg Beneran Mau 💗",
    confirmText: "Mulai dari sekarang kita resmi Balikaann",
    badgeText: "Sayanggkuuu",
    nextButton: "Lanjut ",
    repeatButton: "Ulangi pertanyaan",
    flowerTitle: "Niihh kado buat ayang hihihihi ",
    takeBouquetButton: "Ambil Kadonyaaa ",
    bouquetMessage: "Yeay! Terima kacii ayangg 💕",
    nextFlowerButton: "Lanjutt ",
    collageTitle: "Pacarr Cantikkuuu",
    collageSubtitle: "Cantiikknyaa ayangkuu,terima kasih udah lahir ya ayang,dengan kehadiran ayang bikin hidup aga berwarna. 💕",
    nextCollageButton: "Sekali lagi ya ayangg… ",
    finalTitle: "I Love You More ayangg,Always 💞",
    finalMessage: `Terima Kasihh yaaa ayaang udahh mauu maafiin agaa,agaa Janji ga akann ulangi lagiii dan agaa janji ga bakalan ada yang pernahh gantiin posisi ayang di hidup agaaa 💕`,
    restartButton: "Ulang lagi ",
    copyButton: "Salin Pesan Agaa ",
